...
##Write a query that return the person who has pent the most money.
...
##Q-6 Write a query to return the email, first name, last name and Genre of all Rock Music listners.
...
##Write a query that return the artist name and total track count of top  rock bands?
